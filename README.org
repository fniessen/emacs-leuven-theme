...
purpose!)?  You find that Org-mode headlines are too big?
...
You don't like my large Org agenda-date heading either?
...
That recipe can of course be applied to other faces.
