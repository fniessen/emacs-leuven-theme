...
#+Time-stamp: <2014-09-21 Sun 18:33>
...
finally found a theme that fits me exactly." -- zeltak

"The Leuven theme has quickly become my favorite -- the colors are great and the
visual details for Org mode are just wonderful." -- Steve B.

"I'm using leuven theme also, which is a great theme for Org-mode." -- Joseph
Vidal-Rosset
