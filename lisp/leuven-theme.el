...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(term-color-cyan ((,class (:foreground "DeepSkyBlue"))))
   `(term-color-green ((,class (:foreground "ForestGreen"))))
   `(term-color-magenta ((,class (:foreground "magenta3"))))
   `(term-color-red ((,class (:foreground "red3"))))
   `(term-color-white ((,class (:foreground "white"))))
   `(term-color-yellow ((,class (:foreground "yellow3"))))
   `(term-bold ((,class (:weight normal))))
