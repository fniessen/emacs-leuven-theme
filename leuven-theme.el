...
;; Time-stamp: <2013-01-28 Mon 10:30>
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(highlight ((t ,volatile-highlight)))
   `(region ((t ,region)))
   ...
   `(calendar-today ((,class (:weight bold :background "#FFFFCB"))))
   ...
   `(cfw:face-today ((,class (:foreground "black" :background "#FFFFCB"))))
   `(cfw:face-today-title ((,class (:foreground "#4A95EB" :background "#FFFFCB"))))
   ...
   `(org-agenda-date-today ((,class (:height 1.6 :weight bold :foreground "black" :background "#FFFFCB"))))
