...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(magit-blame-heading ((,class (:foreground "red" :background "#E6E6E6"))))
   `(magit-blame-hash ((,class (:foreground "red" :background "#E6E6E6"))))
   `(magit-blame-name ((,class (:foreground "#036A07" :background "#E6E6E6"))))
   `(magit-blame-date ((,class (:foreground "blue" :background "#E6E6E6"))))
   `(magit-blame-summary ((,class (:weight bold :foreground "#707070" :background "#E6E6E6"))))
